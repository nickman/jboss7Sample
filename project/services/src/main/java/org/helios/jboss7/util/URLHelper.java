...
/**
 * <p>Title: URLHelper</p>
 * <p>Description: Static utility methods for dealing with boiler-plate URL related operations</p> 
 * <p>Copied from: <code>org.helios.apmrouter.util.URLHelper</code></p> 
 * @author Whitehead 
 * <p><code>org.helios.jboss7.util.URLHelper</code></p>
 */
...
public class URLHelper {
	...
	public static URL toURL(File file) {
		try {
			if(file==null) throw new IllegalArgumentException("Passed file was null", new Throwable());
	...
	public static URL toURL(CharSequence urlStr) {
		try {
			if(urlStr==null) throw new IllegalArgumentException("Passed string was null", new Throwable());
	...
	public static URI toURI(CharSequence uriStr) {
		try {
			if(uriStr==null) throw new IllegalArgumentException("Passed string was null", new Throwable());
			return new URI(uriStr.toString());
		} catch (Exception e) {
			throw new RuntimeException("Failed to create URI from string [" + uriStr + "]", e);
		}
	}
