...
/**
 * <p>Title: JMXHelper</p>
 * <p>Description: JMX Utility class</p> 
 * @author Whitehead 
 * <p><code>org.helios.jboss7.util.JMXHelper</code></p>
 */
public class JMXHelper {
	/** The property name where the jmx default domain is referenced */
	public static final String JMX_DOMAIN_PROPERTY = "com.helios.jmx";
	 ...
	 */
	public static MBeanServer getICEMBeanServer() {
		MBeanServer server = null;
		String jmxDomain = System.getProperty(JMX_DOMAIN_PROPERTY, "DefaultDomain");
		if(jmxDomain!=null) {
	...
	public static ObjectName[] query(MBeanServerConnection server, ObjectName pattern, QueryExp query) {
		try {
			if(server==null) server = getICEMBeanServer();
	...
	public static ObjectName[] query(ObjectName pattern, QueryExp query) {
		return query(getICEMBeanServer(), pattern, query);
	}
	...
	public static ObjectName[] query(CharSequence pattern, QueryExp query) {
		return query(getICEMBeanServer(), objectName(pattern), query);
	}
	...
	public static ObjectName[] query(ObjectName pattern) {
		return query(getICEMBeanServer(), pattern, null);
	}
	...
	public static ObjectName[] query(CharSequence pattern) {
		return query(getICEMBeanServer(), objectName(pattern), null);
	}
	...
	public static void registerMBean(ObjectName objectName, Object mbean) {
		registerMBean(getICEMBeanServer(), objectName, mbean);
	}
	...
	public static void registerMBean(Object mbean, ObjectName objectName) {
		registerMBean(getICEMBeanServer(), mbean, objectName);
	}
	...
	public static void unregisterMBean(ObjectName objectName) {
		unregisterMBean(getICEMBeanServer(), objectName);
	}
	...
	public static Map<String, Object> getAttributes(ObjectName on, String...attributes) {
		return getAttributes(on, getICEMBeanServer(), attributes);
	}
	...
	public static String[] getAttributeNames(ObjectName objectName) {
		return getAttributeNames(objectName, getICEMBeanServer());
	}
	...
	public static String[] getAttributeNames(ObjectName objectName, MBeanServerConnection connection) {
		...
		if(connection==null) connection = getICEMBeanServer();		
		try {
