...
ALTER TABLE PUBLIC.AGENT ADD CONSTRAINT IF NOT EXISTS PUBLIC.AGENT_HOST_FK FOREIGN KEY(HOST_ID) REFERENCES PUBLIC.HOST(HOST_ID) ;     
ALTER TABLE PUBLIC.METRIC ADD CONSTRAINT IF NOT EXISTS PUBLIC.METRIC_TRACE_TYPE_FK FOREIGN KEY(TYPE_ID) REFERENCES PUBLIC.TRACE_TYPE(TYPE_ID) ;       
ALTER TABLE PUBLIC.METRIC ADD CONSTRAINT IF NOT EXISTS PUBLIC.METRIC_AGENT_FK FOREIGN KEY(AGENT_ID) REFERENCES PUBLIC.AGENT(AGENT_ID) ;


ALTER TABLE PUBLIC.METRICVALUE ADD CONSTRAINT IF NOT EXISTS PUBLIC.METRICVALUE_METRIC_FK FOREIGN KEY(METRIC_ID) REFERENCES PUBLIC.METRIC(METRIC_ID) ;
...
MERGE INTO PUBLIC.TRACE_TYPE KEY(TYPE_ID) VALUES(0, 'LONG_COUNTER');
MERGE INTO PUBLIC.TRACE_TYPE KEY(TYPE_ID) VALUES(1, 'LONG_GAUGE');
MERGE INTO PUBLIC.TRACE_TYPE KEY(TYPE_ID) VALUES(2, 'DELTA_COUNTER');
MERGE INTO PUBLIC.TRACE_TYPE KEY(TYPE_ID) VALUES(3, 'DELTA_GAUGE');
MERGE INTO PUBLIC.TRACE_TYPE KEY(TYPE_ID) VALUES(4, 'INCREMENTOR');
MERGE INTO PUBLIC.TRACE_TYPE KEY(TYPE_ID) VALUES(5, 'INTERVAL_INCREMENTOR');



-- insert into host (name, domain, first_connected, last_connected, agents, connected) values ('tpmint', 'DefaultDomain', sysdate, sysdate, 0, sysdate)
-- insert into agent (host_id, name, min_level , first_connected , last_connected ) values (1, 'JVMAgent', 0, sysdate, sysdate)
